...
para o outro atacante no outro extremo da rede.

Este ataque é particularmente eficaz em redes \textit{ad-hoc} e redes baseadas em localização. Sendo
estas compremetidas, não conseguiram estabelecer caminhos maiores do que dois hops, causando
interrupções nas comunicações\cite{perrig_survey_ad_hoc,Survey_wsn_Sec_issues}.
