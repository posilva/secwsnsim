...
criptográficas, é necessária a adoptação de esquemas seguros de distribuição de chaves
\cite{eschenauer2002}.
...
necessidade de uma infrastrutura de suporte, explorando o mínimo de consumo de energia. É uma norma
...
\textit{frame}, adicionando a cada frame um \textit{Message Integrity Code}
