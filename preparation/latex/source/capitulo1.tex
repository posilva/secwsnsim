...
comandos de pesquisa). Numa RSSF os nós podem também actuar como nós de
...
de sensores a aplicações executando em sistemas de computadores usuais\cite{gateways}.
...
seguro\cite{Karlof2003,Sec_WSN_Vulnerabilities},
...
importante que se desenvolvam sistemas de simulação\cite{ns2,jsim,SENSE,shox,jprowler,freemote} de
RSSF que
