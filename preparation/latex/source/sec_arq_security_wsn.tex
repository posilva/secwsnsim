...
recursos, que são escassos nas RSSF. Por exemplo, o uso de HMAC's\cite{Stallings2005} é vulgar uma
...
adversário. \cite{SPINS,Luk2007d} Podem-se considerar dois tipos de frescura: frescura
...
mais eficiente, é o uso do modo \textit{offset codebook} (OCB)\cite{Stallings2005}  para encriptação
de
...
implementada em algumas plataformas das RSSF. (ex: Micaz\cite{micaz}).
