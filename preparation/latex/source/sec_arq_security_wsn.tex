...
Note-se que a frescura das mensagens não foi endereçada nesta arquitectura, uma
vez que os autores consideram como demasiado exigente em termos de recursos, o
que contrariaria o objectivo principal da arquitectura.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
iv) Confidencialidade, usa o algoritmo AES\footnote{\textit{Advenced Encryption System
algorithm}}\cite{AES} com 128 bits.
\end{description}
