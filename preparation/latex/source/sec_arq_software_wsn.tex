...
\cite{MICA2,TELOSB} para as mais diferentes aplicações. No que se refere a sistemas operativos
...
(B-MAC\cite{BMAC}, S-MAC\cite{BMAC},Zigbee\cite{zigbee}). No que respeita à camada de
...
Uma RSSF pode ter um protocolo de MAC específico(ex: B-MAC\cite{BMAC}, S-MAC \cite{SMAC}) de
