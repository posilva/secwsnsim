...
Control}}  num único protocolo \textit{Network/MAC} é possível\cite{IGF}, no momento de envio do
...
elaborar as tabelas de encaminhamento, sendo depois propagadas para cada nó.
\end{description}
