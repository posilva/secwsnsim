...
para tomarem as melhores decisões para alcançar os destinos(ex: IGF\cite{IGF}).Os centrados
...
comprometido.
\item[Especificação do protocolo SIGF\cite{SIGF}]
...
três extensões ao protocolo IGF\cite{IGF}que permitem evoluir gradualmente de um protocolo sem
estado para um
