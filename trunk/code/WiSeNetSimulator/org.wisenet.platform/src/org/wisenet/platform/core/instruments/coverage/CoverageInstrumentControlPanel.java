...
import org.wisenet.simulator.components.instruments.coverage.CoverageInstrument.CoverageProbingResult;
...
public class CoverageInstrumentControlPanel extends javax.swing.JPanel implements IInstrumentControlPanel {
    ...
    private void cmdAddReceiversActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddReceiversActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                ...
                CoverageInstrument.getInstance().registerReceiver(handler);
            }
        }
    ...
    private void cmdDelReceiversActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDelReceiversActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                CoverageInstrument.getInstance().unregisterReceiver(handler);
            }
        }
    ...
    private void cmdAddSendersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddSendersActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                CoverageInstrument.getInstance().registerSender(handler);
            }
        }
    ...
    private void cmdDelSendersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDelSendersActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                CoverageInstrument.getInstance().unregisterSender(handler);
            }
        }
    ...
    private void cmdApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdApplyActionPerformed
        CoverageInstrument.getInstance().setAutonumber(chkAutoNumber.isSelected());
        CoverageInstrument.getInstance().setNotifyPanel(chkNotifyPanel.isSelected());
        ((CoverageInstrument) CoverageInstrument.getInstance()).setHowManyMessagesToSentPerSender(Integer.valueOf(txtParamNroMessages.getText()));
        ((CoverageInstrument) CoverageInstrument.getInstance()).setDelayToSentMessages(Long.valueOf(txtParamDelay.getText()));
        ((CoverageInstrument) CoverageInstrument.getInstance()).setIntervalToSentMessages(Long.valueOf(txtParamInterval.getText()));
        ((CoverageInstrument) CoverageInstrument.getInstance()).setTimesToSentMessages(Integer.valueOf(txtParamTimes.getText()));
    ...
    private void cmdResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdResultActionPerformed
        // TODO add your handling code here:
        CoverageInstrument.CoverageProbingResult result = (CoverageProbingResult) CoverageInstrument.getInstance().getLastProbeResult();
        int nrOfCoverageSenderNodes = result.getNumberOfRegistredSenderNodes();
        int nrOfCoverageReceivedNodes = result.getNumberOfRegistredReceivedNodes();
        if (nrOfCoverageSenderNodes > 0) {
            double p = nrOfCoverageReceivedNodes * 100 / nrOfCoverageSenderNodes;
            txtaResult.append("==============================================\n");
            txtaResult.append("Number of Senders Nodes: " + nrOfCoverageSenderNodes + " \n");
            txtaResult.append("Number of Received Nodes Messages: " + nrOfCoverageReceivedNodes + " \n");
    ...
    public synchronized void refresh(Instrument instrument) {
        if (instrument instanceof CoverageInstrument) {
            lblNrSenderNodes.setText("" + CoverageInstrument.getInstance().getSenders().size());
            lblNrReceiverNodes.setText("" + CoverageInstrument.getInstance().getReceivers().size());
        }
    }
}
