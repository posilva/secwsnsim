 ...
 */
package org.wisenet.platform.core.charts.ui;

import java.awt.Rectangle;
import org.jdesktop.application.Action;
import org.wisenet.platform.core.charts.core.XYLineChart;
...
public class ChartPanel extends JPanel implements IChartDisplay {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(org.wisenet.platform.PlatformApp.class).getContext().getActionMap(ChartPanel.class, this);
        exportToPDF.setAction(actionMap.get("ExportChartToPDF")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.wisenet.platform.PlatformApp.class).getContext().getResourceMap(ChartPanel.class);
