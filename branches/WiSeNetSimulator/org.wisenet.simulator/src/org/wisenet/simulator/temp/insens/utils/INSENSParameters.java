 ...
 */
package org.wisenet.simulator.temp.insens.utils;

import org.wisenet.simulator.utilities.CryptoFunctions;
import org.wisenet.simulator.core.Simulator;
import org.wisenet.simulator.core.node.layers.routing.RoutingLayerParameters;

/**
 *
 * @author Pedro Marques da Silva <MSc Student @di.fct.unl.pt>
 */
public class INSENSParameters extends RoutingLayerParameters {

    @Override
    protected void setSupportedParameters() {
        super.setSupportedParameters();
        init("FEEDBACK_START_TIME_BOUND", (long) Simulator.ONE_SECOND * 60);
        init("FEEDBACK_MSG_RECEIVED_TIME_BOUND", (long) Simulator.ONE_SECOND * 30);
        init("FEEDBACK_MSG_RECEIVED_RETRIES", (byte) 3);
        init("MESSAGE_DISPATCH_RATE", (long) Simulator.ONE_SECOND * 1);
        init("CHAIN_SIZE", (int) 100);
        init("MAX_DELAYED_MESSAGE_BOUND", (double) Simulator.ONE_SECOND * 1);
        init("MIN_DELAYED_MESSAGE_BOUND", (double) 2000);
        init("IV_COUNTER", (int) 128219);
    }
