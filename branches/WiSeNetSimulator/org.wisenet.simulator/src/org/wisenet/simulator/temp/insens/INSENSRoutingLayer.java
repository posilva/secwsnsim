...
import org.wisenet.simulator.temp.common.events.DelayedMessageEvent;
import org.wisenet.simulator.temp.insens.attacks.BlackholeRoutingAttack;
import org.wisenet.simulator.temp.insens.basestation.BaseStationController;
import org.wisenet.simulator.temp.insens.basestation.ForwardingTable;
...
import org.wisenet.simulator.temp.insens.messages.INSENSMessagePayloadFactory;
import org.wisenet.simulator.temp.insens.messages.data.DATAPayload;
import org.wisenet.simulator.temp.insens.messages.data.FDBKPayload;
import org.wisenet.simulator.temp.insens.messages.data.RREQPayload;
import org.wisenet.simulator.temp.insens.messages.data.RUPDPayload;
import org.wisenet.simulator.temp.insens.messages.evaluation.EvaluationINSENSDATAMessage;
import org.wisenet.simulator.temp.insens.utils.NeighborInfo;
import org.wisenet.simulator.temp.insens.utils.NetworkKeyStore;
...
public class INSENSRoutingLayer extends RoutingLayer implements IInstrumentHandler {
    ...
    protected void sendMessageToAir(Object message) {
        ...
        log("Messages in queue:  " + messagesQueue.size());
    ...
    protected void onStable(boolean oldValue) {
        if (oldValue == false) {
            ...
            attacks.getAttacksList().getFirst().setEnable(true);
        }
    }
