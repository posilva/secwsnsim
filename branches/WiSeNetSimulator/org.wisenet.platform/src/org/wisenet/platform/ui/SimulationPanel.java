...
import org.wisenet.platform.ui.frames.NodePropertiesDialog;
...
import org.wisenet.platform.utils.others.GoogleMaps;
import org.wisenet.platform.utils.others.ImageViewer;
...
import org.wisenet.simulator.gui.GraphicPoint;
...
public class SimulationPanel extends javax.swing.JPanel implements ISimulationDisplay {
    ...
    private void initComponents() {
        ...
        selNodeAttacksEdit = new javax.swing.JMenuItem();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.wisenet.platform.PlatformApp.class).getContext().getResourceMap(SimulationPanel.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(org.wisenet.platform.PlatformApp.class).getContext().getActionMap(SimulationPanel.class, this);
        ...
        selNodeAttacksEdit.setText("Edit");
        selNodeAttacksEdit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                selNodeAttacksEditActionPerformed(evt);
            }
        });
        selNodeAttacks.add(selNodeAttacksEdit);
...
//                }
    ...
    private void selNodeAttacksEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selNodeAttacksEditActionPerformed

         if (currentSelectedNode != null) {
            loadAttacksFromNode(currentSelectedNode.getPhysicalNode(),evt.getSource());
            update();
        }



    }//GEN-LAST:event_selNodeAttacksEditActionPerformed
    ...
    private javax.swing.JMenuItem selNodeAttacksEdit;
    ...
    /**
     * Create dynamically the routing attacks info
     * For each attack create a menu with 2 sub-menus (Edit,Enable)
     * @param node
     * @param sourceMenu
     */
    private void loadAttacksFromNode(Node node, Object sourceMenu) {
