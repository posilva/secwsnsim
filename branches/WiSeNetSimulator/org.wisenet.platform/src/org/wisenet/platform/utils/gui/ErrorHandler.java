...
public class ErrorHandler {
    ...
    public static String getHTMLDetails(Throwable throwable) {
        ...
        while (throwable != null) {
            ...
            b.append("<b>").append(throwable.getClass().getName()).append("</b>: ").append(throwable.getMessage()).append("<ul>");
            ...
            for (int i = stack.length - lengthOfLastTrace; i >= 0; i--) {
                b.append("<li> in ").append(stack[i].getClassName()).append(".<b>").append(stack[i].getMethodName()).append("</b>() at <tt>").append(stack[i].getFileName()).append(":").append(stack[i].getLineNumber()).append("</tt>");
            }
    ...
    public static class Test {
        ...
        public static void bar(Object o) {
            try {
                ...
                throw new IllegalArgumentException("null argument", e);
            }
        }
