...
public class EnergyModelPanel extends PlatformPanel{
    ...
    public EnergyModel createEnergyModelInstance() {
        ...
        for (int i = 0; i < energyModeltable.getModel().getRowCount(); i++) {
            try {
                ...
                ObjectParameter op =  (ObjectParameter) energyModeltable.getModel().getValueAt(i, 2);
                energyModel.getParameters().set(op.getName(),v);
...
//            parametersFields = AnnotationUtils.readEnergyModelParametersFields(energyModel);
            ObjectParameters op = EnergyModel.getDefaultInstance().getParameters();
            dataVector = new Vector();
//            for (Field f : parametersFields) {
            for (ObjectParameter p : op.getAllParameters()) {
