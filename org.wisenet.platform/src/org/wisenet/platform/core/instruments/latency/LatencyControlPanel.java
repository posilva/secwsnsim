...
package org.wisenet.platform.core.instruments.latency;
...
public class LatencyControlPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(org.wisenet.platform.PlatformApp.class).getContext().getActionMap(LatencyControlPanel.class, this);
        tbtnEnable.setAction(actionMap.get("SetCoverageStatus")); // NOI18N
        tbtnEnable.setIcon(null);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.wisenet.platform.PlatformApp.class).getContext().getResourceMap(LatencyControlPanel.class);
