...
public class CoverageInstrumentControlPanel extends javax.swing.JPanel implements IInstrumentControlPanel {
    ...
    public CoverageInstrumentControlPanel() {
        ...
        if (PlatformManager.getInstance().haveActiveSimulation()) {
            getCoverageInstrument().registerControlPanel(this);
            getCoverageInstrument().setDebugEnabled(true);
        }
        ...
        if (PlatformManager.getInstance().haveActiveSimulation()) {
            ...
            for (Node node : nodes) {
                if (node.getGraphicNode().isSelected()) {
                    ...
                    getCoverageInstrument().registerReceiver(handler);
                }
            }
        }
    ...
    private void cmdDelReceiversActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDelReceiversActionPerformed
        ...
        if (PlatformManager.getInstance().haveActiveSimulation()) {
            ...
            for (Node node : nodes) {
                if (node.getGraphicNode().isSelected()) {
                    IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                    getCoverageInstrument().unregisterReceiver(handler);
                }
            }
        }
    ...
    private void cmdAddSendersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddSendersActionPerformed
        ...
        if (PlatformManager.getInstance().haveActiveSimulation()) {
            ...
            for (Node node : nodes) {
                if (node.getGraphicNode().isSelected()) {
                    IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                    getCoverageInstrument().registerSender(handler);
                }
            }
        }
    ...
    private void cmdDelSendersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDelSendersActionPerformed
        if (PlatformManager.getInstance().haveActiveSimulation()) {
            ...
            for (Node node : nodes) {
                if (node.getGraphicNode().isSelected()) {
                    IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                    getCoverageInstrument().unregisterSender(handler);
                }
            }
        }
    ...
    private void cmdApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdApplyActionPerformed
        if (PlatformManager.getInstance().haveActiveSimulation()) {
            getCoverageInstrument().setAutonumber(chkAutoNumber.isSelected());
            getCoverageInstrument().setNotifyPanel(chkNotifyPanel.isSelected());
            ((CoverageInstrument) getCoverageInstrument()).setHowManyMessagesToSentPerSender(Integer.valueOf(txtParamNroMessages.getText()));
            ((CoverageInstrument) getCoverageInstrument()).setDelayToSentMessages(Long.valueOf(txtParamDelay.getText()));
            ((CoverageInstrument) getCoverageInstrument()).setIntervalToSentMessages(Long.valueOf(txtParamInterval.getText()));
            ((CoverageInstrument) getCoverageInstrument()).setTimesToSentMessages(Integer.valueOf(txtParamTimes.getText()));
        }
    ...
    private void cmdResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdResultActionPerformed
        if (PlatformManager.getInstance().haveActiveSimulation()) {
            CoverageInstrument.CoverageProbingResult result = (CoverageProbingResult) getCoverageInstrument().getLastProbeResult();
    ...
    public synchronized void refresh(AbstractInstrument instrument) {
        if (instrument instanceof CoverageInstrument) {
            lblNrSenderNodes.setText("" + getCoverageInstrument().getSenders().size());
            lblNrReceiverNodes.setText("" + getCoverageInstrument().getReceivers().size());
        }
    }
