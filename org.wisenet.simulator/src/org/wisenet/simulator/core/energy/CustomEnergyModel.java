 ...
 */
public class CustomEnergyModel implements Parameterizable, Persistent {

    EnergyModelParameters parameters = new EnergyModelParameters();

    private static void getEnergyModelDefaultValues(CustomEnergyModel energyModel) throws SecurityException {
    }
    ...
    public CustomEnergyModel getInstanceWithDefaultValues() {
        getEnergyModelDefaultValues(this);
        return this;
    }

    public static CustomEnergyModel getDefaultInstance() {
        CustomEnergyModel energyModel = new CustomEnergyModel();
    ...
    public static void main(String[] args) throws PersistantException {
        CustomEnergyModel cem = new CustomEnergyModel();
