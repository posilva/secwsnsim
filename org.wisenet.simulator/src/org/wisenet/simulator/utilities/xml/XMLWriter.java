...
public class XMLWriter {
    ...
    public void open(String fileName) throws IOException {
        ...
        OutputStreamWriter outwriter = new OutputStreamWriter(bout, XMLWriter.ENCODINGJ);
        this.out = outwriter;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            writer.openTag("Simulation");
            writer.writeTag("Name", "Name of the simulation");
            writer.writeTag("Description", "Description of the simulation");
            writer.openTag("Nodes");
            writer.openTag("Node");
            writer.writeTag("X", "X");
            writer.writeTag("Y", "Y");
            writer.writeTag("Z", "Z");
            writer.writeTag("MaxStrenght", "100");
            writer.closeTag("Node");
            writer.closeTag("Nodes");
            writer.closeTag("Simulation");
