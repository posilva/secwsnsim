...
O sistema de simulação que se apresenta tem caracteristicas inovadoras, principalemente porque contribui para 
uma avaliaçao sistemática e comparativa de protocolos o que permite nivelar as condições de comparação 
entre protocolos que se pretenda estudar. De entre as funcionalidades existentes salientam-se as seguintes:
...
\end{itemize}
O ambiente de simulação em causa permite estudar, sistemática e comparativamente, diferentes
protocolos de encaminhamento seguro em RSSF. Este sistemas é complementado, ainda, com o estabelecimento de uma base
