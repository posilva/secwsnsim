...
\usepackage[lined,boxed,commentsnumbered,portugues]{algorithm2e}
\usepackage{listings}
\usepackage{fancybox}
\usepackage{setspace}
\usepackage{multirow}
...
\hypersetup{
    ...
    pdftitle={Avaliação de condições de fiabilidade e segurança de protocolos de encaminhamento de
dados em redes de sensores sem fios},    % title
    ...
    pdfproducer={Faculdade de Ciências e Tecnologia, UNL}, % producer of the document
...
\title{Avaliação de condições de fiabilidade e segurança de protocolos de encaminhamento de dados em
...
\adviser{Prof. Doutor Henrique João Lopes Domingos}
