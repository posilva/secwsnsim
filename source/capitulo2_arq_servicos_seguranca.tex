...
de operação. Os ataques que visam afectar esta propriedade são denominados por ataques de negação de serviço (\textit{Denial of Service} - \textit{DoS}) \cite{Hu2005}. 
Para além de mecanismos que evitem estes ataques, é necessário garantir que a degradação da rede (na presença de um ataque ) é controlada, ou seja, é proporcional ao número de nós
comprometidos; 
 \item[Integridade]
