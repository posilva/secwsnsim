 ...
 * @author pedro
 */
public class INSENSMessageRREQ extends INSENSMessage {

    int size;
    Vector<Integer> path;
    byte[] MACR;

    public INSENSMessageRREQ(byte[] payload) {
        super(payload);
        wrapper = new Wrapper();
    }
    ...
    protected class Wrapper extends INSENSMessage.Wrapper {
        ...
        public void wrap(DefaultMessage m) {
            try {
                ...
                Logger.getLogger(INSENSMessageRREQ.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
