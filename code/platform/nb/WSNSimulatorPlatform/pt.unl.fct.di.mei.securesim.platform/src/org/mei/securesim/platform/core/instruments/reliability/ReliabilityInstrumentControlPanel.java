 ...
 */
package org.mei.securesim.platform.core.instruments.reliability;
...
import org.mei.securesim.components.instruments.reliability.ReliabilityInstrument.ReliabilityProbingResult;
...
public class ReliabilityInstrumentControlPanel extends javax.swing.JPanel implements IInstrumentControlPanel {
    ...
    public ReliabilityInstrumentControlPanel() {
        initComponents();
        ReliabilityInstrument.getInstance().registerControlPanel(this);
        ReliabilityInstrument.getInstance().setDebugEnabled(true);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.mei.securesim.platform.PlatformApp.class).getContext().getResourceMap(ReliabilityInstrumentControlPanel.class);
    ...
    private void cmdAddReceiversActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddReceiversActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                ...
                ReliabilityInstrument.getInstance().registerReceiver(handler);
            }
        }
    ...
    private void cmdDelReceiversActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDelReceiversActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                ReliabilityInstrument.getInstance().unregisterReceiver(handler);
            }
        }
    ...
    private void cmdAddSendersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddSendersActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                ReliabilityInstrument.getInstance().registerSender(handler);
            }
        }
    ...
    private void cmdDelSendersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdDelSendersActionPerformed
        ...
        for (Node node : nodes) {
            if (node.getGraphicNode().isSelected()) {
                IInstrumentHandler handler = (IInstrumentHandler) node.getRoutingLayer();
                ReliabilityInstrument.getInstance().unregisterSender(handler);
            }
        }
    ...
    private void cmdApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdApplyActionPerformed
        ReliabilityInstrument.getInstance().setAutonumber(chkAutoNumber.isSelected());
        ReliabilityInstrument.getInstance().setNotifyPanel(chkNotifyPanel.isSelected());
        ((ReliabilityInstrument) ReliabilityInstrument.getInstance()).setHowManyMessagesToSentPerSender(Integer.valueOf(txtParamNroMessages.getText()));
        ((ReliabilityInstrument) ReliabilityInstrument.getInstance()).setDelayToSentMessages(Long.valueOf(txtParamDelay.getText()));
        ((ReliabilityInstrument) ReliabilityInstrument.getInstance()).setIntervalToSentMessages(Long.valueOf(txtParamInterval.getText()));
        ((ReliabilityInstrument) ReliabilityInstrument.getInstance()).setTimesToSentMessages(Integer.valueOf(txtParamTimes.getText()));
    ...
    private void cmdResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdResultActionPerformed
        // TODO add your handling code here:
        ReliabilityInstrument.ReliabilityProbingResult result = (ReliabilityProbingResult) ReliabilityInstrument.getInstance().getLastProbeResult();
    ...
    private void chkDebugActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkDebugActionPerformed
        ReliabilityInstrument.getInstance().setDebugEnabled(chkDebug.isSelected());
    ...
    public synchronized void refresh(Instrument instrument) {
        if (instrument instanceof ReliabilityInstrument) {
            lblNrSenderNodes.setText("" + ReliabilityInstrument.getInstance().getSenders().size());
            lblNrReceiverNodes.setText("" + ReliabilityInstrument.getInstance().getReceivers().size());
        }
    }
}
