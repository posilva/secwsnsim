...
public class SimulationPropertiesPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.mei.securesim.platform.PlatformApp.class).getContext().getResourceMap(SimulationPropertiesPanel.class);
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(resourceMap.getString("jPanel2.border.title"))); // NOI18N
        jPanel2.setName("jPanel2"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(org.mei.securesim.platform.PlatformApp.class).getContext().getActionMap(SimulationPropertiesPanel.class, this);
    ...
    public void SetFastMode() {
        SimulationController.getInstance().setMode(SimulationController.FAST);
    }

    @Action
    public void SetRealtimeMode() {
        SimulationController.getInstance().setMode(SimulationController.REAL);
    }
    ...
    private void loadSimulationSettings() {
        tgbFastMode.setSelected(SimulationController.getInstance().getMode() == SimulationController.FAST);
        tgbRealTimeMode.setSelected(SimulationController.getInstance().getMode() == SimulationController.REAL);
    }
}
